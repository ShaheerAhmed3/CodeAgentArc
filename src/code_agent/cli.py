...
def main(argv: list[str] | None = None) -> int:
    ...
    normalize.add_argument("--documentation", type=Path, default=Path("architecture/inputs/Architecture_Documentation.md"))
    normalize.add_argument("--views", type=Path, default=Path("architecture/inputs/Architecture_View.md"))
    ...
    generation.add_argument("--architecture-doc", type=Path, default=Path("architecture/inputs/Architecture_Documentation.md"))
    generation.add_argument("--architecture-view", type=Path, default=Path("architecture/inputs/Architecture_View.md"))
